...
<body>
    ...
    <div id="main">
        ...
        <div class="main-content container-fluid">
            ...
            <ul class="fa-ul">
                <li>
                    <span class="fa-li"></span><i class="fas fa-arrow-right"  style="color:#FC6B30"></i> A sua organização: que considera essa matéria a partir de sua estrutura orgânica interna das entidades; ou 
                </li>
                <li>
                    <span class="fa-li"></span><i class="fas fa-arrow-right"  style="color:#FC6B30"></i> A partir de controles societários externos: que são refletidos basicamente no mercado de controle societário. 
                </li>
            </ul>
            <hr>
