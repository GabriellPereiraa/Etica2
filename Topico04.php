                        ...
                        <div id="collapse1" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
                            <div class="card-body">
                                ...
                                <ul class="fa-ul">
                                    <li>
                                        <p class="Texto">
                                            <span class="fa-li"><i class="fas fa-arrow-right" style="color: #FC6B30;"></i></span><strong> Um marco legal que permita a investigação e acusação independentes:</strong>
                                        </p>
                                        <p class="Texto">
                                    ...
                                    <li>
                                        <p class="Texto">
                                            <span class="fa=li"><i class="fas fa-arrow-right" style="color: #FC6B30;"></i></span><strong> Mecanismos adequados de responsabilidade e participação:</strong>
                                        </p>
                                        <p class="Texto">
                                    ...
                                    <li>
                                        <p class="Texto">
                                            <span class="fa=li"><i class="fas fa-arrow-right" style="color: #FC6B30;"></i></span><strong> Votações públicas:</strong>
                                        </p>
                                        <p class="Texto">
                    ...
                    <div class="card">
                        ...
                        <div id="collapse2" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                            ...
                            <ul class="fa-ul">
                                <li>
                                    <p class="Texto">
                                        <span class="fa-li"><i class="fas fa-arrow-right" style="color: #FC6B30;"></i></span><strong> Compromisso bem articulado dos líderes políticos:</strong>
                                    </p>
                                    <p class="Texto">
                                ...
                                <li>
                                    <p class="Texto">
                                        <span class="fa-li"><i class="fas fa-arrow-right" style="color: #FC6B30;"></i></span><strong> Códigos de conduta que determinem que os valores e normas sejam aplicáveis:</strong>
                                    </p>
                                    <p class="Texto">
                                ...
                                <li>
                                    <p class="Texto">
                                        <span class="fa-li"><i class="fas fa-arrow-right" style="color: #FC6B30;"></i></span><strong> Mecanismos ou atividades de socialização profissionais tais como a educação e formação:</strong>
                                    </p>
                                    <p class="Texto">
